...
{
	/// <summary>
	/// Represents a request for plaid's '<c>/identity/get</c>' endpoint. The Identity endpoint allows you to retrieve various account holder information on file with the financial institution, including names, emails, phone numbers, and addresses.
	/// </summary>
