...
/// <summary>
/// <para>Request input for listing reviews for an individual watchlist screening</para>
/// </summary>
public partial class ListWatchlistScreeningIndividualReviewsRequest : RequestBase
{
	/// <summary>
