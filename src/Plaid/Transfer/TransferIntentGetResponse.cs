...
public record TransferIntentGetResponse : ResponseBase
{
	...
	public Entity.TransferIntentGetResponseStatusEnum Status { get; init; } = default!;
	...
	public Entity.TransferIntentGetResponseAuthorizationDecisionEnum? AuthorizationDecision { get; init; } = default!;
