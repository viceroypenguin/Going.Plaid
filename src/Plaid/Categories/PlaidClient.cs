...
public sealed partial class PlaidClient
{
	...
	/// <para>All implementations are recommended to <a href="https://plaid.com/docs/transactions/pfc-migration/">use the newer <c>personal_finance_category</c> taxonomy</a> instead of the legacy <c>category</c> taxonomy supported by this endpoint. The <a href="https://plaid.com/documents/transactions-personal-finance-category-taxonomy.csv"><c>personal_finance_category taxonomy</c> CSV file</a> is available for download and is not accessible via API.</para>
	/// </summary>
