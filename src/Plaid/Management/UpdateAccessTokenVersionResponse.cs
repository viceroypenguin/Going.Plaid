...
{
	/// <summary>
	/// Represents a response from plaid's '<c>/item/access_token/update_version</c>' endpoint. If you have an access_token from the legacy version of Plaid’s API, you can use the '<c>/item/access_token/update_version</c>' endpoint to generate an access_token for the Item that works with the current API.
	/// </summary>
