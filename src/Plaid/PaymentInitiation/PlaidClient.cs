...
public sealed partial class PlaidClient
{
	...
	/// <para>In Limited Production, payments must be below 5 GBP or other chosen <a href="https://plaid.com/docs/api/products/payment-initiation/#payment_initiation-payment-create-request-amount-currency">currency</a>, and standing orders, variable recurring payments, and Virtual Accounts are not supported.</para>
	/// </summary>
