...
public partial class WebhookBaseConverter : JsonConverter<WebhookBase>
{
	private static readonly Dictionary<(WebhookType, WebhookCode), Type> s_map =
		new()
		{
			...
			[(WebhookType.Income, WebhookCode.UserIncomeVerification)] = typeof(UserIncomeVerificationStatusWebhook),
			[(WebhookType.Income, WebhookCode.IncomeVerificationRiskSignals)] = typeof(IncomeVerificationRiskSignalsStatusWebhook),
			[(WebhookType.Income, WebhookCode.UserIncomeVerificationRiskSignals)] = typeof(UserIncomeVerificationRiskSignalsStatusWebhook),
			...
			[(WebhookType.CashFlowUpdates, WebhookCode.CashFlowInsightsUpdated)] = typeof(CashFlowUpdatesInsightsV2Webhook),
			...
			[(WebhookType.Income, WebhookCode.UserIncomeVerificationRefreshReconnectNeeded)] = typeof(UserIncomeVerificationRefreshReconnectNeededWebhook),
