...
public record BaseReportAccountInsights
{
	...
	/// <summary>
	/// <para>Customers must transition from <c>longest_gap_between_transactions</c> by October 31st 2024. Longest gap between sequential transactions in a time period. This array can include multiple time periods.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>Customers must transition from <c>average_inflow_amount</c> by October 31st 2024. Average amount of debit transactions into the account in a time period. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>Customers must transition from <c>average_outflow_amount</c> by October 31st 2024. Average amount of transactions out of the account in a time period. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.</para>
	/// </summary>
