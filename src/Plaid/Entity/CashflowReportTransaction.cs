...
/// <summary>
/// <para>A representation of a transaction returned from Cashflow Report</para>
/// </summary>
public record CashflowReportTransaction
{
	/// <summary>
	...
	public Entity.CashflowReportPaymentMeta PaymentMeta { get; init; } = default!;
