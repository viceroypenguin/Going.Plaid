...
/// <summary>
/// <para>A representation of an Item within a VOA report.</para>
/// </summary>
public record CraVoaReportItem
{
	/// <summary>
	/// <para>Data about each of the accounts open on the Item.</para>
	/// </summary>
	[JsonPropertyName("accounts")]
	public IReadOnlyList<Entity.CraVoaReportAccount> Accounts { get; init; } = default!;
