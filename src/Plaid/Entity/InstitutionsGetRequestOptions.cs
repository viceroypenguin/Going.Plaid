...
{
	/// <summary>
	/// <para>Filter the Institutions based on which products they support. Will only return institutions that support all listed products. When filtering based on <c>auth</c>, an institution must support Instant Auth to match the criterion. To filter for Signal support, use <c>balance</c>. To filter for Transfer support, use <c>auth</c>.</para>
	/// </summary>
