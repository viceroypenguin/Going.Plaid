...
public record CraReportGetResponseProduct
{
	...
	public IReadOnlyDictionary<string, Entity.CraReportGetResponseProductMetadataObject>? Metadata { get; init; } = default!;

	/// <summary>
	/// <para>A map of product attributes, where the key is a string and the value can be any JSON value. The specific list of attributes depends on the product and version. For a full list, see the data dictionary. May be <c>null</c> if attributes were not available.</para>
	/// </summary>
	[JsonPropertyName("attributes")]
	public IReadOnlyDictionary<string, Entity.CraReportGetResponseProductAttributesObject>? Attributes { get; init; } = default!;
