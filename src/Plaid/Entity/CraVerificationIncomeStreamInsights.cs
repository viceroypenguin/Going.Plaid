...
/// </summary>
public record CraVerificationIncomeStreamInsights
{
	/// <summary>
	...
	public Entity.CraVerificationIncomeCategory IncomeCategory { get; init; } = default!;

	/// <summary>
	/// <para>The income pay frequency.</para>
	/// </summary>
	[JsonPropertyName("pay_frequency")]
	public Entity.CraVerificationIncomePayFrequency PayFrequency { get; init; } = default!;

	/// <summary>
	/// <para>The object containing data about the income provider.</para>
	/// </summary>
	[JsonPropertyName("income_provider")]
	public Entity.CraVerificationIncomeProvider? IncomeProvider { get; init; } = default!;

	/// <summary>
	/// <para>The status of the income source.</para>
	/// </summary>
	[JsonPropertyName("status")]
	public Entity.CraVerificationIncomeStatus Status { get; init; } = default!;

	/// <summary>
	/// <para>Metadata of the income stream's next payment.</para>
	/// </summary>
	[JsonPropertyName("next_payment")]
	public Entity.CraVerificationIncomeNextPayment? NextPayment { get; init; } = default!;
