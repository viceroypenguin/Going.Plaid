...
/// </summary>
public record CraVerificationIncomeStream
{
	/// <summary>
	...
	public Entity.CraVerificationIncomeStreamInsights Insights { get; init; } = default!;

	/// <summary>
	/// <para>Modeled income metrics for a given income stream or user summary.</para>
	/// </summary>
	[JsonPropertyName("income_metrics")]
	public Entity.CraVerificationIncomeMetrics IncomeMetrics { get; init; } = default!;

	/// <summary>
	/// <para>The transactions data for the income stream ordered by ascending date.</para>
	/// </summary>
	[JsonPropertyName("transactions")]
	public IReadOnlyList<Entity.CraVerificationIncomeTransaction> Transactions { get; init; } = default!;
