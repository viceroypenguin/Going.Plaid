...
/// <summary>
/// <para>Data from a government watchlist or PEP list that has been attached to the screening.</para>
/// </summary>
public record WatchlistScreeningHit
{
	/// <summary>
	/// <para>ID of the associated screening hit.</para>
	/// </summary>
	[JsonPropertyName("id")]
	...
	public Entity.IndividualWatchlistCode ListCode { get; init; } = default!;
