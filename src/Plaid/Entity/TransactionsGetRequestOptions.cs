...
public class TransactionsGetRequestOptions
{
	...
	/// <para>Plaid is also introducing Category Rules - a new endpoint that will enable you to change the <c>personal_finance_category</c> for a transaction based on your users’ needs. When rules are set, the selected category will override the Plaid provided category. To learn more, send a note to transactions-feedback@plaid.com.</para>
	/// </summary>
