...
public record BaseReportAccount
{
	...
	/// <summary>
	/// <para>Transaction history associated with the account. Transaction history returned by endpoints such as <c>/transactions/get</c> or <c>/investments/transactions/get</c> will be returned in the top-level <c>transactions</c> field instead. Some transactions may have their details masked in accordance to the FCRA. These will appear with a <c>credit_category</c> of <c>MASKED_TRANSACTION_CATEGORY</c>.</para>
	/// </summary>
