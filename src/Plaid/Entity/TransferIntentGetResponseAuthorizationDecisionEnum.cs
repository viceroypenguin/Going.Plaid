...
public enum TransferIntentGetResponseAuthorizationDecisionEnum
{
	...
	/// <summary>
	/// <para>– Plaid reviewed the proposed transfer and declined processing. Refer to the <c>code</c> field in the <c>decision_rationale</c> object for details. Null value otherwise.</para>
	/// </summary>
