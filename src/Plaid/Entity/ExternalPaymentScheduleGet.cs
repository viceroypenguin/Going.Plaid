...
/// </summary>
public record ExternalPaymentScheduleGet
{
	/// <summary>
	/// <para>The frequency interval of the payment.</para>
	/// </summary>
	[JsonPropertyName("interval")]
	public Entity.PaymentScheduleInterval Interval { get; init; } = default!;
	...
	public int IntervalExecutionDay { get; init; } = default!;
