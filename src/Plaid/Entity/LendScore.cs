...
{
	/// <summary>
	/// <para>The score returned by the Lend Score model. Will be an integer in the range 1 to 99.</para>
	/// </summary>
	[JsonPropertyName("score")]
	public int? Score { get; init; } = default!;

	/// <summary>
	/// <para>The reasons for an individual having risk according to the Lend Score.</para>
	/// </summary>
