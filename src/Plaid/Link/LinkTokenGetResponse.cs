...
public record LinkTokenGetResponse : ResponseBase
{
	...
	/// <summary>
	/// <para>Information about Link sessions created using this <c>link_token</c>. This field will only be present if your client is enabled for Hosted Link. Session data will be provided for up to six hours after the session has ended.</para>
	/// </summary>
