...
public partial class LinkTokenCreateRequest : RequestBase
{
	...
	/// <summary>
	/// <para>A unique ID generated by Plaid representing the end user. Typically this ID will come from the <c>/user/create</c> response. **Required** if the <c>user</c> object isn't included. If this field is included, then the remaining <c>user</c> object fields are ignored.</para>
	/// </summary>
