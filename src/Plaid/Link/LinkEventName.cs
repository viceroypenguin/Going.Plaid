...
namespace Going.Plaid.Link
{
	...
	public enum LinkEventName
	{
		...
		/// </summary>
		[Description("The user closed the third-party website or mobile app without completing the OAuth flow.")]
		...
		/// </summary>
		[Description("The user has exited without completing the Link flow and the onExit callback is fired.")]
		...
		/// </summary>
		[Description("The user encountered an error while completing the third-party's OAuth login flow.")]
		...
		/// </summary>
		[Description("The user has opened my.plaid.com. This event is only sent when Link is initialized with assets as a product")]
		...
		/// </summary>
		[Description("The user has navigated to a third-party website or mobile app in order to complete the OAuth login flow.")]
		...
		/// </summary>
		[Description("The TransitionView event indicates that the user has moved from one view to the next.")]
