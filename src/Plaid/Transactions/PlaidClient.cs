...
public sealed partial class PlaidClient
{
	...
	/// <para>This endpoint can only be called on an Item that has already been initialized with Transactions (either during Link, by specifying it in <c>/link/token/create</c>; or after Link, by calling <c>/transactions/get</c>). After the <a href="https://plaid.com/docs/api/products/transactions/#historical_update"><c>HISTORICAL_UPDATE</c></a> webhook has fired, call <c>/transactions/recurring/get</c> to receive the Recurring Transactions streams and subscribe to the <a href="https://plaid.com/docs/api/products/transactions/#recurring_transactions_update"><c>RECURRING_TRANSACTIONS_UPDATE</c></a> webhook.</para>
	...
	/// <para>The product is currently in beta. To request access, contact enrich-feedback@plaid.com</para>
	/// </summary>
