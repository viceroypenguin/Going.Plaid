...
/// <summary>
/// <para>Request schema for <c>/beta/partner/customer/v1/create</c>.</para>
/// </summary>
public partial class BetaPartnerCustomerV1CreateRequest : RequestBase
{
	/// <summary>
